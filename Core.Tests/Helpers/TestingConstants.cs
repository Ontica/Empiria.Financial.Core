/* Empiria Financial *****************************************************************************************
*                                                                                                            *
*  Module   : Financial Core Module Tests                Component : Tests Helpers                           *
*  Assembly : Empiria.Financial.Core.Tests.dll           Pattern   : Testing constants                       *
*  Type     : TestingConstants                           License   : Please read LICENSE.txt file            *
*                                                                                                            *
*  Summary  : Provides testing constants for the Empiria Financial Core module.                              *
*                                                                                                            *
