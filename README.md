...
Este repositorio contiene los servicios y tipos básicos para desarrollar soluciones de software de corte financiero.
...
El acceso a los servicios que ofrece este repositorio del *backend* se realiza mediante llamadas a servicios web de tipo RESTful,
...
Estge repositorio se conforma de los siguientes módulos:

1.  **Core**  
    Casos de uso, servicios, tipos y clases de propósito general para el desarrollo de soluciones financieras.

2. **Web API**  
    Capa de servicios web HTTP/Json para interactuar con todos los módulos que conforman el *backend*.  
